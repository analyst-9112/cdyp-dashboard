      ...
      <div className="dataloggers-form">
        <div className="dataloggers-form-inner">
          <Row id="dashboard-form-banner-wrapper" gutter={0}>
            <Col span={24}>
              <div id="dashboard-form-banner">Code Differently Youth Program Dashboard</div>
            </Col>
          </Row>
          ...
          >
            ...
            <div key="c">
              <div className="highcharts-custom-step-wrapper">
                <GridLayoutCell
                  ...
                  headerFontSize={headerFontSize}
                  headerHeight={headerHeight}
                  headerTitle={"What Coding Languages Do you Know?"}
                  headerBackgroundHoverColor={"rgba(250,250,250,0.5)"}
                  headerBackgroundColor={"rgba(250,250,250,1)"}
                  contentBackgroundColor={"#fff"}
                >
            ...
            <div key="d">
              <div className="highcharts-custom-step-wrapper">
                <GridLayoutCell
                  ...
                  headerFontSize={headerFontSize}
                  headerHeight={headerHeight}
                  headerTitle={"Any Past Coding Experience?"}
                  headerBackgroundHoverColor={"rgba(250,250,250,0.5)"}
                  headerBackgroundColor={"rgba(250,250,250,1)"}
                  contentBackgroundColor={"#fff"}
                >
            ...
            <div key="e">
              <div className="highcharts-custom-windir-wrapper">
                <GridLayoutCell
                  ...
                  headerFontSize={headerFontSize}
                  headerHeight={headerHeight}
                  headerTitle={"Computer- School Issued or Personal?"}
                  headerBackgroundHoverColor={"rgba(250,250,250,0.5)"}
                  headerBackgroundColor={"rgba(250,250,250,1)"}
                  contentBackgroundColor={"#fff"}
                >
            ...
            <div key="f">
              <div className="highcharts-custom-windrose-wrapper">
                <GridLayoutCell
                  ...
                  headerFontSize={headerFontSize}
                  headerHeight={headerHeight}
                  headerTitle={"Computer - MacBook vs. Chromebook"}
                  headerBackgroundHoverColor={"rgba(250,250,250,0.5)"}
                  headerBackgroundColor={"rgba(250,250,250,1)"}
                  contentBackgroundColor={"#fff"}
                >
            ...
            {/* <div key="g">
              <div className="highcharts-custom-windir-wrapper2">
                <GridLayoutCell
                  headerClassName={"grid-layout-item-header"}
                  headerLinesColor={"#ccc"}
                  headerLinesPadding={"1rem"}
